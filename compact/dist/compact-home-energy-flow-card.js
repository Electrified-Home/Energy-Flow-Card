(function(){"use strict";function $(){return{schema:[{name:"grid_entity",label:"Grid",required:!0,selector:{entity:{domain:"sensor",device_class:"power"}}},{name:"grid_icon",selector:{icon:{}},context:{icon_entity:"grid_entity"}},{name:"grid_tap_action",label:"Grid Tap Action",selector:{"ui-action":{}}},{name:"grid_hold_action",label:"Grid Hold Action",selector:{"ui-action":{}}},{name:"load_entity",label:"Load",required:!0,selector:{entity:{domain:"sensor",device_class:"power"}}},{name:"load_icon",selector:{icon:{}},context:{icon_entity:"load_entity"}},{name:"load_tap_action",label:"Load Tap Action",selector:{"ui-action":{}}},{name:"load_hold_action",label:"Load Hold Action",selector:{"ui-action":{}}},{name:"production_entity",label:"Production",required:!0,selector:{entity:{domain:"sensor",device_class:"power"}}},{name:"production_icon",selector:{icon:{}},context:{icon_entity:"production_entity"}},{name:"production_tap_action",label:"Production Tap Action",selector:{"ui-action":{}}},{name:"production_hold_action",label:"Production Hold Action",selector:{"ui-action":{}}},{name:"battery_entity",label:"Battery",required:!0,selector:{entity:{domain:"sensor",device_class:"power"}}},{name:"battery_icon",selector:{icon:{}},context:{icon_entity:"battery_entity"}},{name:"battery_tap_action",label:"Battery Tap Action",selector:{"ui-action":{}}},{name:"battery_hold_action",label:"Battery Hold Action",selector:{"ui-action":{}}},{name:"battery_soc_entity",label:"Battery SOC (%) Entity",selector:{entity:{domain:"sensor"}}},{name:"invert_battery_data",label:"Invert Battery Data",selector:{boolean:{}}}]}}function A(c){if(c.load)return c;const t=s=>{const r=c[`${s}_entity`];if(!r)return;const a={entity:r},l=c[`${s}_icon`],d=c[`${s}_tap_action`],b=c[`${s}_hold_action`];return l!==void 0&&(a.icon=l),d!==void 0&&(a.tap=d),b!==void 0&&(a.hold=b),a},o=t("load"),e=t("grid"),i=t("production"),n=t("battery");if(n){const s=c.battery_soc_entity,r=c.invert_battery_data;s!==void 0&&(n.soc_entity=s),r!==void 0&&(n.invert={data:r})}return o?{load:o,grid:e,production:i,battery:n}:c}function B(c){const t=Math.max(0,c.production),o=c.grid,e=c.battery,i=Math.max(0,c.load),n={productionToLoad:0,productionToBattery:0,productionToGrid:0,gridToLoad:0,gridToBattery:0,batteryToLoad:0};let s=t,r=i;if(s>0&&r>0&&(n.productionToLoad=Math.min(s,r),s-=n.productionToLoad,r-=n.productionToLoad),e<0&&s>0&&(n.productionToBattery=Math.min(s,Math.abs(e)),s-=n.productionToBattery),e>0&&r>0&&(n.batteryToLoad=Math.min(e,r),r-=n.batteryToLoad),r>0&&o>0&&(n.gridToLoad=Math.min(o,r),r-=n.gridToLoad),e<0&&o>10){const a=Math.abs(e)-n.productionToBattery;a>1&&(n.gridToBattery=Math.min(o-n.gridToLoad,a))}return o<-10&&(n.productionToGrid=Math.abs(o)),n}function H(c,t,o,e){const i=c[o];return i?i.icon?i.icon:i.entity&&t?.states[i.entity]&&t.states[i.entity].attributes.icon||e:e}function F(c,t,o,e){if(!c)return;const i=o||{action:"more-info"},n=i.action||"more-info";switch(n==="default"?"more-info":n){case"more-info":const r=i.entity||e;r&&t("hass-more-info",{entityId:r});break;case"navigate":{const a=i.path??i.navigation_path;a&&(history.pushState(null,"",a),t("location-changed",{replace:!1,path:a}),window.dispatchEvent(new CustomEvent("location-changed",{detail:{replace:!1,path:a},bubbles:!0,composed:!0})))}break;case"url":i.path&&window.open(i.path);break;case"toggle":e&&c.callService("homeassistant","toggle",{entity_id:e});break;case"call-service":if(i.service){const[a,l]=i.service.split(".");c.callService(a,l,i.service_data||{},i.target)}break}}function _(c,t,o){if(!c||!o){c?.setAttribute("data-width-px","");return}t>=80?c.setAttribute("data-width-px","show-label"):t>=40?c.setAttribute("data-width-px","show-icon"):c.setAttribute("data-width-px","")}class O{constructor(t,o,e,i,n,s){this.productionColor="#256028",this.batteryColor="#104b79",this.gridColor="#7a211b",this.returnColor="#7a6b1b",this.container=t,this.config=o,this.hass=e,this.viewMode=i,this.getIconCallback=n,this.handleActionCallback=s}setConfig(t){this.config=t}render(t){(!this.container.querySelector(".compact-view")||this.lastViewMode!==this.viewMode)&&(this.initializeStructure(),this.attachEventHandlers(),this.lastViewMode=this.viewMode),this.updateSegments(t)}setViewMode(t){this.viewMode!==t&&(this.viewMode=t,this.lastViewMode=void 0)}initializeStructure(){this.container.innerHTML=`
    ...
    `}attachEventHandlers(){requestAnimationFrame(()=>{const t=this.container.querySelector("#production-segment"),o=this.container.querySelector("#battery-segment"),e=this.container.querySelector("#grid-segment"),n=this.container.querySelectorAll(".row-value")[0];if(t&&t.addEventListener("click",()=>{this.handleActionCallback(this.config.production?.tap,this.config.production?.entity)}),o&&o.addEventListener("click",()=>{this.handleActionCallback(this.config.battery?.tap,this.config.battery?.entity)}),e&&e.addEventListener("click",()=>{this.handleActionCallback(this.config.grid?.tap,this.config.grid?.entity)}),n&&n.addEventListener("click",()=>{this.handleActionCallback(this.config.load.tap,this.config.load.entity)}),this.viewMode==="compact-battery"){const s=this.container.querySelector("#battery-production-segment"),r=this.container.querySelector("#battery-load-segment"),a=this.container.querySelector("#battery-grid-segment"),l=this.container.querySelector("#battery-soc-left"),d=this.container.querySelector("#battery-soc-right");s&&s.addEventListener("click",()=>{this.handleActionCallback(this.config.production?.tap,this.config.production?.entity)}),r&&r.addEventListener("click",()=>{this.handleActionCallback(this.config.load.tap,this.config.load.entity)}),a&&a.addEventListener("click",()=>{this.handleActionCallback(this.config.grid?.tap,this.config.grid?.entity)}),l&&l.addEventListener("click",()=>{this.handleActionCallback(this.config.battery?.tap,this.config.battery?.entity)}),d&&d.addEventListener("click",()=>{this.handleActionCallback(this.config.battery?.tap,this.config.battery?.entity)})}})}updateSegments(t){const{load:o,flows:e,battery:i,batterySoc:n}=t,s=e.productionToLoad,r=e.batteryToLoad,a=e.gridToLoad,l=o||1,d=s/l*100,b=r/l*100,g=a/l*100,h=d+b+g;let p=d,m=b,u=g;if(h>0){const w=100/h;p=d*w,m=b*w,u=g*w}let y=0,x=0,f=0,v=0,E=0,q=0;if(this.viewMode==="compact-battery"){if(i<0){const C=Math.abs(i)||1;y=e.gridToBattery,f=e.productionToBattery;const S=e.gridToBattery/C*100,L=e.productionToBattery/C*100,T=S+L;if(T>0){const k=100/T;v=S*k,q=L*k}}else if(i>0){const w=i||1,C=i-e.batteryToLoad;x=e.batteryToLoad,y=C;const S=e.batteryToLoad/w*100,L=C/w*100,T=S+L;if(T>0){const k=100/T;E=S*k,v=L*k}}}requestAnimationFrame(()=>{this.updateLoadBar(p,m,u,d,b,g,s,r,a,o),this.viewMode==="compact-battery"&&this.updateBatteryBar(v,E,q,y,x,f,i,n)})}updateLoadBar(t,o,e,i,n,s,r,a,l,d){const b=this.container.querySelector("#production-segment"),g=this.container.querySelector("#battery-segment"),h=this.container.querySelector("#grid-segment"),p=this.container.querySelector("#load-value-text"),m=this.container.querySelector(".bar-container");if(b){b.style.width=`${t}%`;const u=b.querySelector(".bar-segment-label");u&&r>0&&(u.textContent=`${Math.round(i)}%`);const y=t/100*(m?.clientWidth||0);_(b,y,r>0)}if(g){g.style.width=`${o}%`;const u=g.querySelector(".bar-segment-label");u&&a>0&&(u.textContent=`${Math.round(n)}%`);const y=o/100*(m?.clientWidth||0);_(g,y,a>0)}if(h){h.style.width=`${e}%`;const u=h.querySelector(".bar-segment-label");u&&l>0&&(u.textContent=`${Math.round(s)}%`);const y=e/100*(m?.clientWidth||0);_(h,y,l>0)}p&&(p.textContent=String(Math.round(d)))}updateBatteryBar(t,o,e,i,n,s,r,a){const l=this.container.querySelector("#battery-grid-segment"),d=this.container.querySelector("#battery-load-segment"),b=this.container.querySelector("#battery-production-segment"),g=this.container.querySelector("#battery-soc-left"),h=this.container.querySelector("#battery-soc-right"),p=this.container.querySelector("#battery-soc-text-left"),m=this.container.querySelector("#battery-soc-text-right"),y=this.container.querySelectorAll(".bar-container")[1];let x=!1;if(r<0?(x=!0,g&&(g.style.display="none"),h&&(h.style.display="flex"),m&&a!==null&&(m.textContent=a.toFixed(1))):r>0?(x=!1,g&&(g.style.display="flex"),h&&(h.style.display="none"),p&&a!==null&&(p.textContent=a.toFixed(1))):(g&&(g.style.display="none"),h&&(h.style.display="flex"),m&&a!==null&&(m.textContent=a.toFixed(1))),l){const f=x?this.gridColor:this.returnColor;l.style.width=`${t}%`,l.style.background=f;const v=l.querySelector(".bar-segment-label");v&&i>0&&(v.textContent=`${Math.round(i)}W`);const E=t/100*(y?.offsetWidth||0);_(l,E,i>0)}if(d){d.style.width=`${o}%`;const f=d.querySelector(".bar-segment-label");f&&n>0&&(f.textContent=`${Math.round(n)}W`);const v=o/100*(y?.offsetWidth||0);_(d,v,n>0)}if(b){b.style.width=`${e}%`;const f=b.querySelector(".bar-segment-label");f&&s>0&&(f.textContent=`${Math.round(s)}W`);const v=e/100*(y?.offsetWidth||0);_(b,v,s>0)}}}class z extends HTMLElement{constructor(){super(),this._resizeObserver=null}static getStubConfig(){return{}}static getConfigForm(){return $()}connectedCallback(){this._resizeObserver=new ResizeObserver(()=>{}),this.parentElement&&this._resizeObserver.observe(this.parentElement),this._resizeObserver.observe(this)}disconnectedCallback(){this._resizeObserver&&(this._resizeObserver.disconnect(),this._resizeObserver=null)}setConfig(t){this._config=A(t),this._renderSafely("setConfig")}set hass(t){this._hass=t,this._renderSafely("hass update")}_renderSafely(t){try{this._render()}catch(o){console.error("[CompactHomeEnergyFlowCard] render failed during",t,o),this.innerHTML=`
        <ha-card>
          <div style="padding:16px;">
            Compact Home Energy Flow Card failed to render. Check browser console for details.
          </div>
        </ha-card>
      `}}_render(){if(!this._config||!this._hass||!this._config.load)return;const t=this._getEntityState(this._config.grid?.entity),o=this._getEntityState(this._config.load.entity),e=this._getEntityState(this._config.production?.entity),i=this._getEntityState(this._config.battery?.entity),n=parseFloat(t?.state??"0")||0,s=parseFloat(o?.state??"0")||0,r=parseFloat(e?.state??"0")||0;let a=parseFloat(i?.state??"0")||0;this._config.battery?.invert?.data&&(a=-a);const d=!!this._config.battery?.soc_entity?"compact-battery":"compact";this._compactRenderer?(this._compactRenderer.setConfig(this._config),this._compactRenderer.setViewMode(d)):this._compactRenderer=new O(this,this._config,this._hass,d,(h,p)=>H(this._config,this._hass,h,p),(h,p)=>F(this._hass,this._fireEvent.bind(this),h,p));const b=B({grid:n,production:r,load:s,battery:a});let g=null;if(this._config.battery?.soc_entity){const h=this._getEntityState(this._config.battery.soc_entity);g=parseFloat(h?.state??"0")||0}this._compactRenderer.render({grid:n,load:s,production:r,battery:a,flows:b,batterySoc:g})}_getEntityState(t){if(t)return this._hass?.states?.[t]}_fireEvent(t,o={}){if(t==="call-service"&&this._hass){this._hass.callService(o.domain,o.service,o.service_data||{},o.target);return}const e=new CustomEvent(t,{detail:o,bubbles:!0,composed:!0});this.dispatchEvent(e)}}const M="compact-home-energy-flow-card";customElements.get(M)?console.info("[CompactHomeEnergyFlowCard] custom element already defined"):(customElements.define(M,z),console.info("[CompactHomeEnergyFlowCard] defined custom element")),window.customCards=window.customCards||[],window.customCards.push({type:"compact-home-energy-flow-card",name:"Compact Home Energy Flow Card",description:"Compact bar visualization of home energy flows"}),window.dispatchEvent(new Event("ll-rebuild"))})();
