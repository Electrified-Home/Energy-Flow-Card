...
`;var Yt=Object.defineProperty,V=(a,t,e,i)=>{for(var s=void 0,n=a.length-1,o;n>=0;n--)(o=a[n])&&(s=o(t,e,s)||s);return s&&Yt(t,e,s),s};const G=class G extends Bt{constructor(){super(...arguments),this.viewMode="compact",this.segmentVisibilityRaf=null,this.renderDataQueued=!1,this.productionColor="#256028",this.batteryColor="#104b79",this.gridColor="#7a211b",this.returnColor="#7a6b1b",this.animation=new qt}static getStubConfig(){return{}}static getConfigForm(){return zt()}disconnectedCallback(){super.disconnectedCallback(),this.animation.stop(),this.segmentVisibilityRaf!==null&&(cancelAnimationFrame(this.segmentVisibilityRaf),this.segmentVisibilityRaf=null)}setConfig(t){const e=Nt(t);e.animation===void 0&&(e.animation=!1),this.config=e,this.isConnected&&(this.resetSubscriptions(),this.isAnimationEnabled()||this.animation.stop())}setupSubscriptions(){if(!this.config)return;const t=()=>{this.renderDataQueued||(this.renderDataQueued=!0,queueMicrotask(()=>{this.renderDataQueued=!1,this.updateRenderData()}))};this.config.grid?.entity&&this.subscribe(this.config.grid.entity,t),this.config.load?.entity&&this.subscribe(this.config.load.entity,t),this.config.production?.entity&&this.subscribe(this.config.production.entity,t),this.config.battery?.entity&&this.subscribe(this.config.battery.entity,t),this.config.battery?.soc_entity&&this.subscribe(this.config.battery.soc_entity,t)}updateRenderData(){if(!this.config||!this.hass)return;const t=this.hass.states[this.config.grid?.entity||""],e=this.hass.states[this.config.load?.entity||""],i=this.hass.states[this.config.production?.entity||""],s=this.hass.states[this.config.battery?.entity||""],n=parseFloat(t?.state??"0")||0,o=parseFloat(e?.state??"0")||0,c=parseFloat(i?.state??"0")||0;let r=parseFloat(s?.state??"0")||0;this.config.battery?.invert?.data&&(r=-r);const l=Wt({grid:n,production:c,load:o,battery:r});let h=null;if(this.config.battery?.soc_entity){const d=this.hass.states[this.config.battery.soc_entity];h=parseFloat(d?.state??"0")||0}this.viewMode=h!==null?"compact-battery":"compact",this.renderData={grid:n,load:o,production:c,battery:r,flows:l,batterySoc:h}}render(){if(!this.config||!this.renderData)return T`<ha-card class="compact-card"><div style="padding:16px;">Waiting for configuration...</div></ha-card>`;const{load:t,flows:e,battery:i,batterySoc:s}=this.renderData,n=this.isAnimationEnabled(),o=jt(t,e);return n&&this.animation.setLoadSpeed(t),T`
    ...
    `}renderBatteryRow(t,e,i){const s=Vt(t,e);this.isAnimationEnabled()&&this.animation.setBatteryAnimation(t,s.direction);const n=s.gridIsImport?this.gridColor:this.returnColor,o=i!==null?i.toFixed(1):"--",c=t>0;return T`
    ...
    `}isAnimationEnabled(){return this.config?.animation!==!1}getIconFor(t){const e={grid:"mdi:transmission-tower",load:"mdi:home-lightning-bolt",production:"mdi:solar-power",battery:"mdi:battery"};return It(this.config,this.hass,t,e[t])}renderShineOverlay(t){const e=t==="horizontal"?"shine-overlay shine-horizontal load-shine":"shine-overlay shine-vertical battery-shine";return T`
      <div class="${e}"></div>
      <div class="${e}"></div>
    `}handleClick(t,e){this.hass&&Ft(this.hass,this.fireEvent.bind(this),t,e)}fireEvent(t,e={}){if(t==="call-service"&&this.hass){this.hass.callService(e.domain,e.service,e.service_data||{},e.target);return}const i=new CustomEvent(t,{detail:e,bubbles:!0,composed:!0});this.dispatchEvent(i)}updated(t){super.updated(t),this.isAnimationEnabled()?this.shadowRoot&&this.animation.start(this.shadowRoot):this.animation.isRunning()&&this.animation.stop(),t.has("renderData")&&this.renderData&&this.segmentVisibilityRaf===null&&(this.segmentVisibilityRaf=requestAnimationFrame(()=>{this.segmentVisibilityRaf=null,this.updateSegmentVisibility()}))}updateSegmentVisibility(){if(!this.shadowRoot||!this.renderData)return;const{flows:t}=this.renderData,e=this.shadowRoot.querySelector(".compact-row:not(#battery-row) .bar-container");if(e){const i=e.clientWidth;if(i>0){const s=this.shadowRoot.querySelector("#production-segment"),n=this.shadowRoot.querySelector("#battery-segment"),o=this.shadowRoot.querySelector("#grid-segment");if(s){const c=parseFloat(s.style.width)/100*i;B(s,c,t.productionToLoad>0)}if(n){const c=parseFloat(n.style.width)/100*i;B(n,c,t.batteryToLoad>0)}if(o){const c=parseFloat(o.style.width)/100*i;B(o,c,t.gridToLoad>0)}}}if(this.viewMode==="compact-battery"){const i=this.shadowRoot.querySelector("#battery-row .bar-container");if(i){const s=i.clientWidth;s>0&&i.querySelectorAll(".bar-segment").forEach(o=>{const c=parseFloat(o.style.width)/100*s,r=o.querySelector(".bar-segment-label"),l=!!(r?.textContent&&r.textContent.trim()!=="");B(o,c,l)})}}}};G.styles=Gt;let w=G;V([lt({attribute:!1})],w.prototype,"config"),V([ht()],w.prototype,"viewMode"),V([ht()],w.prototype,"renderData");const dt="compact-home-energy-flow-card";customElements.get(dt)?console.info("[CompactHomeEnergyFlowCard] custom element already defined"):(customElements.define(dt,w),console.info("[CompactHomeEnergyFlowCard] defined custom element")),window.customCards=window.customCards||[],window.customCards.push({type:"compact-home-energy-flow-card",name:"Compact Home Energy Flow Card",description:"Compact bar visualization of home energy flows"})})();
