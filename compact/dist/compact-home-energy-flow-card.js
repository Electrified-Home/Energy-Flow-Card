(function(){"use strict";function $(c){const t=Math.max(0,c.production),o=c.grid,e=c.battery,i=Math.max(0,c.load),n={productionToLoad:0,productionToBattery:0,productionToGrid:0,gridToLoad:0,gridToBattery:0,batteryToLoad:0};let s=t,r=i;if(s>0&&r>0&&(n.productionToLoad=Math.min(s,r),s-=n.productionToLoad,r-=n.productionToLoad),e<0&&s>0&&(n.productionToBattery=Math.min(s,Math.abs(e)),s-=n.productionToBattery),e>0&&r>0&&(n.batteryToLoad=Math.min(e,r),r-=n.batteryToLoad),r>0&&o>0&&(n.gridToLoad=Math.min(o,r),r-=n.gridToLoad),e<0&&o>10){const a=Math.abs(e)-n.productionToBattery;a>1&&(n.gridToBattery=Math.min(o-n.gridToLoad,a))}return o<-10&&(n.productionToGrid=Math.abs(o)),n}function A(c,t,o,e){const i=c[o];return i?i.icon?i.icon:i.entity&&t?.states[i.entity]&&t.states[i.entity].attributes.icon||e:e}function B(c,t,o,e){if(!c)return;const i=o||{action:"more-info"},n=i.action||"more-info";switch(n==="default"?"more-info":n){case"more-info":const r=i.entity||e;r&&t("hass-more-info",{entityId:r});break;case"navigate":{const a=i.path??i.navigation_path;a&&(history.pushState(null,"",a),t("location-changed",{replace:!1,path:a}),window.dispatchEvent(new CustomEvent("location-changed",{detail:{replace:!1,path:a},bubbles:!0,composed:!0})))}break;case"url":i.path&&window.open(i.path);break;case"toggle":e&&c.callService("homeassistant","toggle",{entity_id:e});break;case"call-service":if(i.service){const[a,l]=i.service.split(".");c.callService(a,l,i.service_data||{},i.target)}break}}function _(c,t,o){if(!c||!o){c?.setAttribute("data-width-px","");return}t>=80?c.setAttribute("data-width-px","show-label"):t>=40?c.setAttribute("data-width-px","show-icon"):c.setAttribute("data-width-px","")}class H{constructor(t,o,e,i,n,s){this.productionColor="#256028",this.batteryColor="#104b79",this.gridColor="#7a211b",this.returnColor="#7a6b1b",this.container=t,this.config=o,this.hass=e,this.viewMode=i,this.getIconCallback=n,this.handleActionCallback=s}setConfig(t){this.config=t}render(t){(!this.container.querySelector(".compact-view")||this.lastViewMode!==this.viewMode)&&(this.initializeStructure(),this.attachEventHandlers(),this.lastViewMode=this.viewMode),this.updateSegments(t)}setViewMode(t){this.viewMode!==t&&(this.viewMode=t,this.lastViewMode=void 0)}initializeStructure(){this.container.innerHTML=`
      <ha-card>
        <style>
          :host {
            display: block;
